...
const solenEl = document.querySelector('.sun-card')
  ...
  solenEl.addEventListener('click', function() { visPanel(solenEl, 'solen') })
  merkurEl.addEventListener('click', function() { visPanel(merkurEl, 'merkur') })
  venusEl.addEventListener('click', function() { visPanel(venusEl, 'venus') })
  jordenEl.addEventListener('click', function() { visPanel(jordenEl, 'jorden') })
  marsEl.addEventListener('click', function() { visPanel(marsEl, 'mars') })
  jupiterEl.addEventListener('click', function() { visPanel(jupiterEl, 'jupiter') })
  saturnEl.addEventListener('click', function() { visPanel(saturnEl, 'saturn') })
  uranusEl.addEventListener('click', function() { visPanel(uranusEl, 'uranus') })
  neptunEl.addEventListener('click', function() { visPanel(neptunEl, 'neptun') })
